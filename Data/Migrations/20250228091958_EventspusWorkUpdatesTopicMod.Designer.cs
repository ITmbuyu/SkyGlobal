...
namespace SkyGlobal.Data.Migrations
{
    ...
    [Migration("20250228091958_EventspusWorkUpdatesTopicMod")]
    partial class EventspusWorkUpdatesTopicMod
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkyGlobal.Models.Event", b =>
                {
                    ...
                    b.Property<int?>("EventCategorieId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EventCategorieId");

                    b.ToTable("Events");
                });

            modelBuilder.Entity("SkyGlobal.Models.EventCategorie", b =>
                {
                    b.Property<int>("EventCategorieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EventCategorieId"));

                    b.Property<string>("EventCategorieName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("EventCategorieId");
            ...
            modelBuilder.Entity("SkyGlobal.Models.LeaveStatus", b =>
                {
                    b.Property<int>("LeaveStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SkyGlobal.Models.LeaveType", b =>
                {
                    b.Property<int>("LeaveTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SkyGlobal.Models.LeaveRequest", b =>
                {
                    ...
                    b.HasOne("SkyGlobal.Models.LeaveType", "LeaveType")
                        .WithMany()
