...
namespace SkyGlobal.Controllers
{
    public class LeaveTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LeaveTypeId,Type")] LeaveType leaveType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LeaveTypeId,Type")] LeaveType leaveType)
        {
